...
class MLPCritic(nn.Module):
    ...
    def __init__(self, obs_dim, r_dim, hidden_sizes, activation):
        super().__init__()
        self.v_net = mlp([obs_dim] + list(hidden_sizes) + [r_dim], activation)
...
class MLPActorCritic(nn.Module):
    ...
    def __init__(self, observation_space, action_space, r_dim,
        ...
        self.v = MLPCritic(obs_dim, r_dim, hidden_sizes, activation)
