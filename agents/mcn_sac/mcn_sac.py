...
import gym
import time
import spinup.algos.pytorch.mcn_sac.core as core
...
def mcn_sac(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
...
if __name__ == '__main__':
    ...
    mcn_sac(lambda : gym.make(args.env), actor_critic=core.MLPActorCritic,
