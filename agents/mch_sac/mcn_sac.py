...
import gym
import time
import spinup.algos.pytorch.mch_sac.core as core
...
class ReplayBuffer:
    ...
    def __init__(self, obs_dim, act_dim, size, r_dim):
...
def mch_sac(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    def compute_loss_q(data):
        ...
        with torch.no_grad():
            ...
            backup = r + gamma * (1 - d[...,None]) * (q_pi_targ - alpha * logp_a2[...,None])
    ...
    def test_agent():
        for j in range(num_test_episodes):
            ...
            while not(d or (ep_len == max_ep_len)):
                ...
                o, _, d, _ = test_env.step(get_action(o, True))
...
if __name__ == '__main__':
    ...
    mch_sac(lambda : gym.make(args.env), actor_critic=core.MLPActorCritic,
