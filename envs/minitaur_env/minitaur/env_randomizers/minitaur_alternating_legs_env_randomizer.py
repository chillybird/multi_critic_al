...
from envs.minitaur_env.minitaur import env_randomizer_base
...
class MinitaurAlternatingLegsEnvRandomizer(env_randomizer_base.EnvRandomizerBase):
  ...
  def randomize_env(self, env):
    ...
    logger.info("swing_offset: {}".format(perturb_magnitude))
    ...
    logger.info("extension_offset: {}".format(perturb_magnitude))
    ...
    logger.info("desired_pitch: {}".format(perturb_magnitude))
    ...
    logger.info("battery_voltage: {}".format(randomized_battery_voltage))
    ...
    logger.info("motor_damping: {}".format(randomized_motor_damping))
