...
from envs.minitaur_env.minitaur import minitaur
from envs.minitaur_env.minitaur import minitaur_derpy
from envs.minitaur_env.minitaur import minitaur_logging
from envs.minitaur_env.minitaur import minitaur_logging_pb2
from envs.minitaur_env.minitaur import minitaur_rainbow_dash
from envs.minitaur_env.minitaur import motor
from pkg_resources import parse_version
from envs.minitaur_env.minitaur.utils import get_forward_reward
...
class MinitaurGymEnv(gym.Env):
    ...
    def __init__(self,
        ...
        # self._objective_weights = [distance_weight, energy_weight, shake_weight]
    ...
    def get_minitaur_motor_velocities(self):
        ...
        """
        return np.array(self._observation[MOTOR_VELOCITY_OBSERVATION_INDEX:MOTOR_VELOCITY_OBSERVATION_INDEX +
                                                               NUM_MOTORS])
    ...
    def _reward(self):
        ...
        # forward_reward = min(get_forward_reward(self._last_base_position, current_base_position), self._forward_reward_cap)
        ...
        # print("forward_reward:", forward_reward, "drift_reward: ", drift_reward, " shake_reward: ", shake_reward)
        roll, pitch, _ = self.minitaur.GetTrueBaseRollPitchYaw()
        if math.fabs(pitch) > 0.14:
            forward_reward = -math.fabs(forward_reward)
        objectives = [forward_reward, energy_reward, drift_reward, shake_reward]
        # objectives = [forward_reward, energy_reward, shake_reward]
