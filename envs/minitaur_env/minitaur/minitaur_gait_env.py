# -*- coding:utf-8 -*-
# @Time : 2022/3/25 18:15
# @Author: zhcode
# @File : minitaur_gait_env.py
import math
...
class MinitaurGaitEnv(minitaur_gym_env.MinitaurGymEnv):
    ...
    def reset(self):
        ...
        super(MinitaurGaitEnv, self).reset(initial_motor_angles=initial_motor_angles, reset_duration=0.5)
        return self._get_observation()

    def _convert_from_leg_model(self, leg_pose):
        """Converts leg space(extension angle, swing angle) action into motor commands(motor angle θ1 and θ2).
    ...
    def _gen_signal(self, t, phase):
        ...
        The foot (leg tip) will move in a ellipse specified by extension and swing amplitude.
    ...
    def _signal(self, t):
        ...
        """
        signal = np.array(self._init_pose) + np.zeros(NUM_LEGS * 2)
        return signal
